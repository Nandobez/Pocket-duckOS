...
static void set_left_shift(char val)
{
	is_lshift_down = val;
}

static void set_right_shift(char val)
{
	is_rshift_down = val;
}
...
char toascii(unsigned char sc)
{
	...
	switch(sc) {
		case 42:	set_left_shift(1);
				break;
		case 170:	set_left_shift(0);
				break;
		case 54:	set_right_shift(1);
				break;
		case 182:	set_right_shift(0);
				break;
